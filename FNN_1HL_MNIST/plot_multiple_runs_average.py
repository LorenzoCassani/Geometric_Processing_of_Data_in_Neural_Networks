...
plt.xlim(0, 150)
plt.ylim(0, 0.25)
plt.savefig('../../Desktop/Tesi/Figures/MNIST/multiple_runs_average/errors.png', dpi=300)
plt.show()

# Plot: radius of gyration
plt.figure(figsize = (10, 6))
plt.plot(np.arange(1, num_epochs + 1, 1), gyradius_even_mean, label = '"even" manifold')
plt.fill_between(np.arange(1, num_epochs + 1, 1), gyradius_even_lower, gyradius_even_upper, alpha=0.2)
plt.plot(np.arange(1, num_epochs + 1, 1), gyradius_odd_mean, label = '"odd" manifold')
plt.fill_between(np.arange(1, num_epochs + 1, 1), gyradius_odd_lower, gyradius_odd_upper, alpha=0.2)
plt.xticks(np.arange(0, num_epochs + 1, 15))
...
plt.xlim(0, 150)
plt.ylim(0.6, 1.0)
plt.savefig('../../Desktop/Tesi/Figures/MNIST/multiple_runs_average/radius_of_gyration.png', dpi=300)
plt.show()
...
plt.xlim(0, 150)
plt.ylim(1.0, 1.5)
plt.savefig('../../Desktop/Tesi/Figures/MNIST/multiple_runs_average/ctc_distance.png', dpi=300)
plt.show()
...
plt.xlim(0, 150)
plt.ylim(0.4, 0.9)
plt.savefig('../../Desktop/Tesi/Figures/MNIST/multiple_runs_average/dimensionless_radius_of_gyration.png', dpi=300)
plt.show()