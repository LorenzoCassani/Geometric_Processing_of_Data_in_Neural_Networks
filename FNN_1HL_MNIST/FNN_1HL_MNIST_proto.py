...
class FCNN(nn.Module):
    ...
    def __init__(self, epoch_star, hidden_size, input_size=28*28*1, output_size=2):
        ...
        # NN Hyperparameters
        self.num_data = 2000           # Training set size (Max 60000 for MNIST dataset)
    ...
    def stragglers(self, dataset, run):
        ...
        f_out = open("{}/stragglers_list/stragglers_at_epoch_{}.dat".format(PATH, self.epoch_star), "w+")
    ...
    def training_session(self, run, num_epochs, innerdata=False):
        ...
        f = open('{}/stragglers_list/stragglers_at_epoch_{}.dat'.format(PATH, self.epoch_star), 'r')
