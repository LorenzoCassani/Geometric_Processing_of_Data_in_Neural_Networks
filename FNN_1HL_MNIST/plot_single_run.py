...
plt.xlim(0, 200)
plt.ylim(0, 0.25)
plt.savefig('../../Desktop/Tesi/Figures/MNIST/single_run/errors.png', dpi=300)
plt.show()
...
plt.xlim(0, 200)
plt.ylim(0.6, 1.0)
plt.savefig('../../Desktop/Tesi/Figures/MNIST/single_run/radius_of_gyration.png', dpi=300)
plt.show()
...
plt.xticks(np.arange(0, num_epochs + 1, 20))
plt.yticks(np.arange(1.0, 1.8, 0.1))
plt.xlabel('training epoch', fontsize='xx-large')
plt.ylabel('centre-to-centre distance', fontsize='xx-large')
plt.grid()
plt.xlim(0, 200)
plt.ylim(1.0, 1.5)
plt.savefig('../../Desktop/Tesi/Figures/MNIST/single_run/ctc_distance.png', dpi=300)
plt.show()
...
plt.xlim(0, 200)
plt.ylim(0.4, 0.9)
plt.savefig('../../Desktop/Tesi/Figures/MNIST/single_run/dimensionless_radius_of_gyration.png', dpi=300)
plt.show()