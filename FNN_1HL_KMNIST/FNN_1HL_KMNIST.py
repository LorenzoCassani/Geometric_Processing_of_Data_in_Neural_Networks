...
class FCNN(nn.Module):
    ...
    def __init__(self, hidden_size, input_size=28*28*1, output_size=2):
        ...
        # NN Hyperparameters
        self.num_data = 10000          # Training set size (Max 60000 for KMNIST dataset)
        ...
        # Dataset
        self.dataset = datasets.Custom_KMNIST(num_data=self.num_data, batch_size=self.batch_size)
